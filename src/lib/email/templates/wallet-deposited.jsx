 ...
 * }} props
 */
export default function WalletDeposited({
  firstName = "Client",
  amount = "0",
  newBalance = "0",
}) {
    ...
    <Html lang="fr">
      <Body style={body}>
        <Container style={container}>
          ...
          <Text style={text}>
            Votre wallet EduCash a bien été crédité.
          </Text>

          <Section style={amountBlock}>
            <Text style={amountLabel}>Montant rechargé</Text>
            <Text style={amountValue}>{amount} FCFA</Text>
            <Text style={balanceLine}>
              Nouveau solde disponible : <strong>{newBalance} FCFA</strong>
            </Text>
          </Section>

          <Button href={`${APP_URL}/client/missions/new`} style={button}>
            Publier une mission →
          </Button>
...
const amountValue = { color: "#15803d", fontSize: "32px", fontWeight: "900", margin: "0 0 8px" }
const balanceLine = { color: "#374151", fontSize: "13px", margin: 0 }
